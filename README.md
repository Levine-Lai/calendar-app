...
当前源码和本机最新 APK 为 `2.2.16 / versionCode 38`；GitHub 最新发布版在本轮发布完成前仍为 `2.2.14 / versionCode 36`。

## 主要功能

- 选择联赛和球队，一次导入该球队当前可确定的全部赛程。
- 月历按北京时间展示比赛；点击日期查看详情并刷新当天比分。
- 首页日历上方用淡蓝色列表展示今天的全部已导入比赛，每场比赛单独一行。
...
2. “观赛日记 组件2”：4×3，只显示最新一篇蓝鸟新闻的大图和标题。图片直接铺满整个上半区并使用顶部圆角，标题占下半区；点击打开对应文章。组件每 15 分钟独立检查更新，失败时保留已有缓存。
