...
当前源码和 GitHub 发布版均为 `2.3.5 / versionCode 47`。
...
- `GEMINI_API_KEY`：在 [Google AI Studio](https://aistudio.google.com/app/apikey) 免费创建，用于通过 Gemini 3.5 Flash-Lite 生成 `titleZh`、`summaryZh` 和 `bodyZh`；未配置时英文新闻仍会正常更新。
