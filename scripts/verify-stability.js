...
const checks = [
  ...
  [
    ...
    !index.includes('id="todayGamesList"')
      ...
      && provider.includes("ExistingPeriodicWorkPolicy.UPDATE")
      && provider.includes("OutOfQuotaPolicy.RUN_AS_NON_EXPEDITED_WORK_REQUEST")
      && provider.includes("findEspnEvent(game, liveEvents)")
  ...
  [
    ...
    index.includes('id="deleteEventModal"')
      ...
      && app.includes("AppUpdate?.toDownloadUrl(appUpdateDownloadUrl)")
      && app.includes("plugin?.downloadUpdate")
      && read("public/app-update.js").includes("apkDirectUrl")
      && read("android/app/src/main/java/com/local/sportscalendar/SportsWidgetPlugin.java").includes("Intent.CATEGORY_APP_BROWSER")
      && read("android/app/src/main/java/com/local/sportscalendar/SportsWidgetPlugin.java").includes("base.setComponent")
      && read("android/app/src/main/java/com/local/sportscalendar/SportsWidgetPlugin.java").includes("new ComponentName(")
      && read("android/app/src/main/java/com/local/sportscalendar/SportsWidgetPlugin.java").includes("explicitBrowserIntent(uri)")
